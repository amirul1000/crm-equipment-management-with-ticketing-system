...
?>
  ...
  <div class="center-block w-xxl w-auto-xs p-v-md">
    ...
    <div class="p-lg panel md-whiteframe-z1 text-color m">
      ...
      <form name="reset" method="post">
        <div class="md-form-group">
          <input type="email" name="email" ng-model="email" class="md-input" required>
    ...
    <div class="p-v-lg text-center">Return to <button ui-sref="access.signin" class="md-btn" onClick="window.location.href='index.php';">sign in</button></div>    
  </div>
