    ...
    <div id="content" class="app-content" role="main">
        <div class="box">
            ...
            <div class="navbar md-whiteframe-z1 no-radius blue">
                ...
                <div class="navbar-item pull-left h4">Floor 3 BSM3</div>
                <!-- / -->
                                                ...
                                                <div class="btn-group" role="group" aria-label="...">
                                                    ...
                                                    <div class="btn-group" role="group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-scale pull-right  top text-color">
                                                            ...
                                                            <li><a href="../FilePages/b10f3files.php">Main Archive</a></li>
                                                ...
                                                <div class="p-md">          
                                                    <div class="embed-responsive embed-responsive-4by3">
                                                        <div class="outer-wrap-tank">
                                                            <div class="embed-responsive embed-responsive-4by3">
                                                                <iframe name="b10f3" class="iframe-scale-tank" src="http://162.87.125.214/"></iframe> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="p-md">          
                                                    <div class="embed-responsive embed-responsive-4by3">
                                                        <div class="outer-wrap-file">
                                                            <div class="embed-responsive embed-responsive-4by3">
                                                                <iframe class="iframe-scale-file" src="ftp://162.87.125.232/B10F3"></iframe> 
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
