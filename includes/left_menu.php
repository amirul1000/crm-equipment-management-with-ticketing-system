      ...
      <div class="box bg-white">
        ...
        <div class="box-row">
          <div class="box-cell scrollable hover">
            <div class="box-inner">
              <div class="p hidden-folded blue-50" style="background-image:url(<?=$theme_url?>/html/images/bg.png); background-size:cover">
                <div class="rounded w-64 bg-white inline pos-rlt">
                  <img src="<?=$theme_url?>/html/images/a0.jpg" class="img-responsive rounded">
                </div>
