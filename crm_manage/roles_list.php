                    ...
                    <div class="box-inner padding">                             
                        <div class="row">
                          ...
                          <div class="panel panel-card">
                            <div class="panel-heading"><h3>Role</h3></div>
                            <div class="panel-body">
                             ...
                             <!------------------------------------> 
                                  <script language="javascript">
									 ...
									 {
										window.location.href = 'roles.php?cmd=show_perpage&rowsPerPage='+value; 
									 }
								  </script>       
                            	 &nbsp;&nbsp;&nbsp;<a href="roles.php?cmd=edit" class="btn green">Add a Role</a> 	
                                <table class="table">
                                 <tr>
                                                      ...
                                                      <TR>
                                                        <td width="70%">
                                                             Show<select name="rowsPerPage" id="rowsPerPage"  class="form-control-static" onChange="setrowsPerPage(this.value);">
                                                                  <option value="10" <?php if($_SESSION["rowsPerPage4"]==10){ echo "selected";}?>>10</option>
                                                                  <option value="20" <?php if($_SESSION["rowsPerPage4"]==20){ echo "selected";}?>>20</option>
                                                                  <option value="50" <?php if($_SESSION["rowsPerPage4"]==50){ echo "selected";}?>>50</option>
                                                                  <option value="100" <?php if($_SESSION["rowsPerPage4"]==100){ echo "selected";}?>>100</option>
                                                                  <option value="500" <?php if($_SESSION["rowsPerPage4"]==500){ echo "selected";}?>>500</option>
                                                               </select>Entries
                                                        </td>
                                                        <TD  nowrap="nowrap">
                                                          <?php
                                   ...
                                   <td> 
                                      ...
                                      <div class="table-responsive">	
                                         ...
                                         <?php
                                                ...
                                                $rowsPerPage = isset($_SESSION["rowsPerPage4"])?$_SESSION["rowsPerPage4"]:10;
                                                $pageNum = 1;
                                         ...
                                         ?>
                                            <tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                                              ...
                                              <td nowrap >
                                                  <a href="roles.php?cmd=edit&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
                                                  <a href="roles.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
                                             </td>
