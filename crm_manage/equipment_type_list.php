                        ...
                        <div class="row">
                          <?php
                           ...
                           <div class="panel panel-card">
                            <div class="panel-heading"><h3>Equipment type</h3></div>
                            ...
                            &nbsp;&nbsp;&nbsp;<a href="equipment_type.php?cmd=edit" class="btn green">Add a Equipment type</a>
                <table class="table">
                 <tr>
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										...
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("equipment_type");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_equipment_type" >
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td><?=$arr[$i]['equip_type_name']?></td>
			                  <td><?=$arr[$i]['status']?></td>
			  
							  <td nowrap >
								  <a href="equipment_type.php?cmd=edit&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
								  <a href="equipment_type.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
							 </td>
							  ...
							  <?php              
									  unset($info);
									   ...
									   $res  = $db->select($info);  
										...
										$self = 'equipment_type.php?cmd=list';
										$nav  = '';
