                    ...
                    <div class="box-inner padding">                             
                        <div class="row">
                           ...
                           <div class="panel panel-card">
                            ...
                            &nbsp;&nbsp;&nbsp;<a href="equipment_type.php?cmd=list" class="btn green">List</a>	
                               			 <table class="table">
                                             <tr>
                                              <td>  
                
                                                 <form name="frm_equipment_type" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
                                                 ...
                                                 <div class="table-responsive">	
                                                    <table class="table">
                                                         <tr>
                                                             ...
                                                             <td>
                                                                <input type="text" name="equip_type_name" id="equip_type_name"  value="<?=$equip_type_name?>"   class="form-control-static">
                                                             </td>
                                                         </tr>
                                                         <tr>
                                                             <td>Status</td>
                                                             <td>
                                                             <?php
                                                                    $enumequipment_type = getEnumFieldValues('equipment_type','status');
                                                                ?>
                                                                <select  name="status" id="status"     class="form-control-static">
                                                                <?php
                                                                   foreach($enumequipment_type as $key=>$value)
                                                                   { 
                                                                ?>
