                    ...
                    <div class="box-inner padding">                             
                        <div class="row">
                           ...
                           <div class="panel panel-card">
                            ...
                            &nbsp;&nbsp;&nbsp;<a href="site.php?cmd=list" class="btn green">List</a> 
                                    <table class="table">
                                         <tr>
                                              <td>  
                
                                                 <form name="frm_site" method="post"  enctype="multipart/form-data" onSubmit="return checkRequired();">			
                                             ...
                                             <td>Site Name</td>
                                             <td>
                                                <input type="text" name="site_name" id="site_name"  value="<?=$site_name?>"   class="form-control-static">
                                             </td>
                                         </tr>
                                         <tr>
                                             <td>Status</td>
                                             <td><?php
                                                    $enumsite = getEnumFieldValues('site','status');
                                                ?>
                                                <select  name="status" id="status"     class="form-control-static">
                                                <?php
                                                   foreach($enumsite as $key=>$value)
                                                   { 
                                                ?>
