                    ...
                    <div class="box-inner padding">                             
                        <div class="row">
                          ...
                          <div class="panel panel-card">
                            <div class="panel-heading"><h3>Site</h3></div>
                            <div class="panel-body">
                             ...
                             &nbsp;&nbsp;&nbsp;<a href="site.php?cmd=edit" class="btn green">Add a Site</a> 
                             <table class="table">
                 <tr>
				                ...
				                <table class="table">
									  <TR>
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_site" >
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  ...
							  <td><?=$arr[$i]['site_name']?></td>
			  				  <td><?=$arr[$i]['status']?></td>			  
							  <td nowrap >
								  <a href="site.php?cmd=edit&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
								  <a href="site.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
							 </td>
