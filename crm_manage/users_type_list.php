                          ...
                          <div class="panel panel-card">
                            ...
                            <div class="panel-body">
                             ...
                             <!------------------------------------> 
                            	 ...
                            	 &nbsp;&nbsp;&nbsp;<a href="users_type.php?cmd=edit" class="btn green">Add a users type</a> 	
                                <table class="table">
                                 <tr>
                                             ...
                                             <div class="table-responsive">	
                                                <table class="table">
                                                      <TR>
                                                        ...
                                                        <TD  nowrap="nowrap">
                                                          <?php
                                                              $hash    =  getTableFieldsName("users_type");
                                                        ...
                                                        <td nowrap="nowrap" align="right">
                                                          <input type="hidden" name="cmd" id="cmd" value="search_users_type" >
                                      ...
                                      <div class="table-responsive">	
                                         ...
                                         ?>
                                            <tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                                              ...
                                              <td nowrap >
                                                  <a href="users_type.php?cmd=edit&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
                                                  <a href="users_type.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
                                             </td>
