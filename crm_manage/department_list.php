                        ...
                        <div class="row">
                          ...
                          <div class="panel panel-card">
                            ...
                            <div class="panel-body">
                             ...
                             &nbsp;&nbsp;&nbsp;<a href="department.php?cmd=edit" class="btn green">Add a department</a>
               				 <table class="table">
                               <tr>
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td><?=$arr[$i]['dept_name']?></td>
			  				  <td><?=$arr[$i]['status']?></td>			  
							  <td nowrap >
								  <a href="department.php?cmd=edit&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
								  <a href="department.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
							 </td>
