                    ...
                    <div class="box-inner padding">                             
                        <div class="row">
                          ...
                          <div class="panel panel-card">
                            ...
                            &nbsp;&nbsp;&nbsp;<a href="users.php?cmd=edit" class="btn green">Add a user</a>                            
                <table class="table">
                 <tr>
									  ...
									  <TR>
										...
										<TD  nowrap="nowrap">
										  <?php
											  ...
											  $hash    = array_diff($hash,array("id","password","country_id"));
										  ?>
										  Search Key:
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td><?=$arr[$i]['users_type']?></td>
                              <td><?=$arr[$i]['left_menu']?></td>
                              <td><?=$arr[$i]['roles']?></td>
                              <td><?=$arr[$i]['status']?></td>
			  
							  <td nowrap >
								  <a href="users.php?cmd=edit&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
								  <a href="users.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
							 </td>
