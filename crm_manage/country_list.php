                    ...
                    <div class="box-inner padding">                             
                        <div class="row">
                          ...
                          <div class="panel panel-card">
                            <div class="panel-heading"><h3>Country</h3></div>
                            <div class="panel-body">
                                ...
                                &nbsp;&nbsp;&nbsp;<a href="country.php?cmd=edit" class="btn green">Add a country</a>
                                <table class="table">
                                 <tr>                                        
                                      ...
                                      <div class="table-responsive">	
                                         ...
                                         ?>
                                            <tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                                              ...
                                              <td><?=$arr[$i]['country']?></td>                              
                                              <td nowrap >
                                                  <a href="country.php?cmd=edit&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
                                                  <a href="country.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
                                             </td>
