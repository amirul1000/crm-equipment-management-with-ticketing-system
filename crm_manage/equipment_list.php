                ...
                <div class="box-cell">
                    <div class="box-inner padding">                             
                        <div class="row">
                         ...
                         <a href="equipment.php?cmd=edit" class="btn green">Add a equipment</a> <br><br>
				      ...
				      <div class="table-responsive">	
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td><?=$arr[$i]['file_equpment_info']?></td>
                              <td><?=$arr[$i]['notes']?></td>
                              <td>
		                            <?php
									    unset($info2);        
										$info2['table']    = "users";	
										$info2['fields']   = array("*");	   	   
										$info2['where']    =  "1 AND id='".$arr[$i]['create_by_user_id']."' LIMIT 0,1";
							  ...
							  <td nowrap >
								  <a href="equipment.php?cmd=edit&id=<?=$arr[$i]['id']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
								  <a href="equipment.php?cmd=delete&id=<?=$arr[$i]['id']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
							 </td>
