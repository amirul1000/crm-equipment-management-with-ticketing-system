...
<div class="app">
	<!--#include virtual="/includes/RhNav.html" -->
    <?php include "../includes/RhNav.php"; ?>     
    <!-- content -->
    <div id="content" class="app-content" role="main">
        <div class="box">
            ...
            <div class="navbar md-whiteframe-z1 no-radius blue">
                ...
                <div class="navbar-item pull-left h4">Rheometer Data - Skin Care Global Distribution</div>
                <!-- / -->
                                                ...
                                                <div class="p-md">
                                                    <div class="embed-responsive embed-responsive-4by3">
                                                        <div class="outer-wrap-file">
                                                            <div class="embed-responsive embed-responsive-4by3">
                                                                <iframe class="iframe-scale-file" src="ftp://162.87.125.232/rheometer/trumbull/skincaregd/"></iframe>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
